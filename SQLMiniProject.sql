...
THEN  'expensive' ELSE  'cheap' END AS label
FROM Facilities
...
FROM (
SELECT b.facid, f.name, b.slots, b.slots * f.membercost AS cost
FROM Bookings b
JOIN Facilities f ON f.facid = b.facid
WHERE b.memid != 0
UNION 
SELECT b.facid, f.name, b.slots, b.slots * f.guestcost AS cost
FROM Bookings b
JOIN Facilities f ON f.facid = b.facid
WHERE b.memid = 0
) sub
